...
Revision ID: 86729de9e812
Revises: 
Create Date: 2025-11-16 14:28:05.156155
...
def upgrade():
    ...
    op.create_table('webapp_userdetails',
    ...
    sa.Column('pet_ids', sa.Text(), nullable=True),
    sa.Column('rescue_pets', sa.Text(), nullable=True),
...
def downgrade():
    ...
    op.drop_table('webapp_userdetails')
    # ### end Alembic commands ###
